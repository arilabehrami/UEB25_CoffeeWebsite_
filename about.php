...
//         $('#box').fadeOut(); // Efekti FadeOut
//     });
//     $('#slide-btn').click(function() {
//         $('#box').slideUp(); // Efekti SlideUp
//     });
//     $('#animate-btn').click(function() {
//         $('#box').animate({width: '200px', height: '200px'}, 1000); // Animacion për madhësinë
//     });
// });

// $(document).ready(function() {
//     $('#callback-btn').click(function() {
//         $('#callback-box').fadeOut(1000, function() {
//             alert('Efekti FadeOut përfundoi!');
//         });
//     });
// });

// $(document).ready(function() {
//     // Get dhe Set vlerë të tekstin
//     $('#set-text-btn').click(function() {
//         $('#text').text('Ky tekst është vendosur me jQuery!');
//     });
//     $('#get-text-btn').click(function() {
//         alert($('#text').text()); // Merr tekstin e paragrafit
//     });

//     // Add dhe Remove klasa
//     $('#add-class-btn').click(function() {
//         $('#text').addClass('highlight');  // Shto klasa CSS
//     });
//     $('#remove-class-btn').click(function() {
//         $('#text').removeClass('highlight'); // Heq klasa CSS
//     });
// });
</script>
</head>
